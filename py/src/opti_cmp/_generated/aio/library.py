...
class LibraryNamespace:
    ...
    async def add_asset_permissions(
        self,
        asset_id: str,
        *,
    ...
    async def add_folder_permissions(
        self,
        id: str,
        *,
    ...
    async def create_asset_lineage(
        self,
        asset_id: str,
        *,
    ...
    async def get_rendition_config(
        self,
        id: str,
        *,
        headers: Mapping[str, str] | None = None,
    ...
    async def list_asset_renditions(
        self,
        asset_id: str,
        *,
        offset: int | None = None,
    ...
    async def remove_asset_permission(
        self,
        asset_id: str,
        accessor_id: str,
        *,
    ...
    async def replace_related_assets(
        self,
        asset_id: str,
        *,
    ...
    async def update_asset_permission(
        self,
        asset_id: str,
        accessor_id: str,
        *,
    ...
    async def update_structured_content(
        self,
        id: str,
        *,
