...
class PublishingNamespace:
    ...
    async def bulk_create_publishing_event_metadata(
        self,
    ...
    async def get_publishing_event(
        self,
        publishing_event_id: str,
        *,
        headers: Mapping[str, str] | None = None,
    ...
    async def get_publishing_event_asset_metadata(
        self,
        publishing_event_id: str,
        asset_id: str,
    ...
    async def list_publishing_event_metadata(
        self,
        publishing_event_id: str,
        *,
