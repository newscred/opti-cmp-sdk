...
class WorkRequestNamespace:
    ...
    def add_attachment_to_work_request(
        self,
        id: str,
        *,
    ...
    def add_comment_to_work_request(
        self,
        id: str,
        *,
    ...
    def create_campaign_from_work_request(
        self,
        id: str,
        *,
    ...
    def create_task_from_work_request(
        self,
        id: str,
        *,
    ...
    def create_work_request_creative_asset(
        self,
        id: str,
        *,
    ...
    def delete_work_request_attachment(
        self,
        work_request_id: str,
        attachment_id: str,
        *,
    ...
    def delete_work_request_creative_asset(
        self,
        work_request_id: str,
    ...
    def list_work_request_approved_assets(
        self,
        id: str,
        *,
    ...
    def list_work_request_related_resources(
        self,
        id: str,
        *,
        offset: int | None = None,
    ...
    def update_work_request_form_field(
        self,
        work_request_id: str,
