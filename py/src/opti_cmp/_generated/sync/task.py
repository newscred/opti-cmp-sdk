...
class TaskNamespace:
    ...
    def add_comment_to_task_sub_step(
        self,
        task_id: str,
        step_id: str,
        sub_step_id: str,
    ...
    def add_structured_content_to_task(
        self,
        task_id: str,
        *,
    ...
    def create_task_publishing_intent(
        self,
        task_id: str,
        *,
    ...
    def create_task_structured_content_draft(
        self,
        task_id: str,
        content_id: str,
        *,
    ...
    def delete_task_structured_content(
        self,
        task_id: str,
        content_id: str,
        *,
    ...
    def delete_task_sub_step_comment(
        self,
        task_id: str,
        step_id: str,
        sub_step_id: str,
    ...
    def get_task_structured_content(
        self,
        task_id: str,
        content_id: str,
        *,
    ...
    def get_task_sub_step_external_work(
        self,
        task_id: str,
        step_id: str,
        sub_step_id: str,
    ...
    def list_task_custom_field_choices(
        self,
        task_id: str,
        custom_field_id: str,
        *,
    ...
    def list_task_sub_step_comments(
        self,
        task_id: str,
        step_id: str,
        sub_step_id: str,
    ...
    def update_task_structured_content(
        self,
        task_id: str,
        content_id: str,
        *,
    ...
    def update_task_sub_step_comment(
        self,
        task_id: str,
        step_id: str,
        sub_step_id: str,
    ...
    def update_task_sub_step_external_work(
        self,
        task_id: str,
        step_id: str,
        sub_step_id: str,
