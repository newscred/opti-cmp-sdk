...
class StructuredContentNamespace:
    ...
    def acknowledge_sccontent_preview(
        self,
        content_id: str,
        version_id: str,
        preview_id: str,
    ...
    def complete_sccontent_preview(
        self,
        content_id: str,
        version_id: str,
        preview_id: str,
    ...
    def create_sccontent_type_managed_migration(
        self,
        content_type_id: str,
        *,
    ...
    def create_sccontent_type_version(
        self,
        content_type_id: str,
        *,
    ...
    def delete_sccontent_type_managed_migration(
        self,
        content_type_id: str,
        job_id: str,
        *,
    ...
    def get_sccontent_type_managed_migration(
        self,
        content_type_id: str,
        job_id: str,
        *,
    ...
    def get_sccontent_type_version(
        self,
        content_type_id: str,
        version_id: str,
        *,
    ...
    def list_sccontent_type_managed_migrations(
        self,
        content_type_id: str,
        *,
    ...
    def list_sccontent_type_versions(
        self,
        content_type_id: str,
        *,
        headers: Mapping[str, str] | None = None,
    ...
    def start_sccontent_type_managed_migration(
        self,
        content_type_id: str,
        job_id: str,
        *,
    ...
    def update_sccontent_type_managed_migration(
        self,
        content_type_id: str,
        job_id: str,
        *,
    ...
    def validate_sccontent_type_managed_migration(
        self,
        content_type_id: str,
        *,
